...
- Para conteúdo educativo/anatômico: incluir labels, diagramas, setas e anotações no prompt
...
async def generate_image(request: Request):
    try:
        ...
        if not has_ratio:
            full_prompt = f"Generate a high-quality, detailed, professional image with {aspect}: {prompt}"
        else:
            full_prompt = f"Generate a high-quality, detailed, professional image: {prompt}"
